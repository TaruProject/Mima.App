          ...
          >
            <div className="flex flex-col py-2">
              ...
              >
                ...
                <span className="text-base font-normal text-white">Agregar archivos o fotos</span>
              </button>
              ...
              >
                ...
                <span className="text-base font-normal text-white">Tomar captura de pantalla</span>
              </button>

              {/* Separador */}
              <div className="h-[1px] bg-white/10 my-1 mx-5" />

              {/* GRUPO 2 — Configuración de sesión */}
              <button
                onClick={() => {
                  onSelectMode();
                  // Note: We don't close here because it will open a bottom sheet in Phase 3
                }}
              ...
              >
                <div className="flex items-center gap-[14px]">
                  ...
                  <span className="text-base font-medium text-white">Seleccionar modo</span>
                </div>
