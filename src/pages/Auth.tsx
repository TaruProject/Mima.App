      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-sm">
          <div className="flex flex-col items-center mb-10">
            ...
            <h1 className="text-3xl font-bold text-white">{isLogin ? t("auth.welcome_back") : t("auth.create_account")}</h1>
            <p className="text-slate-400 mt-2 text-center">{isLogin ? t("auth.sign_in_subtitle") : t("auth.sign_up_subtitle")}</p>
          </div>
