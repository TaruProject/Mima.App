...
export const voices: Voice[] = [
  ...
  { id: "YSabzCJMvEHDduIDMdwV", name: "Mima FI-1", region: "Finnish" },
  { id: "c4ZwDxrFaobUF5e1KlEM", name: "Mima FI-2", region: "Finnish" },
  { id: "RiWFFlzYFZuu4lPMig3i", name: "Mima FI-3", region: "Finnish" },
  { id: "cLAH1kXlkAivJHxCW601", name: "Mima SE-1", region: "Swedish" },
  { id: "HqmZnnvy6tCQd8EGWKRT", name: "Mima SE-2", region: "Swedish" },
  { id: "1Iztu4UHnTb9SUjJcpS1", name: "Mima SE-3", region: "Swedish" },
